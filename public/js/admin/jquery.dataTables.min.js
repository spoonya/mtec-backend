...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Вперед",sPrevious:"Назад"},sEmptyTable:"Нет данных в таблице",sInfo:"Показано с _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показано с 0 по 0 из 0 записей",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Показывать _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Обработка...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Записи не найдены"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
